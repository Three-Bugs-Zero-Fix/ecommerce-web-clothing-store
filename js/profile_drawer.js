/* ============================================================
   js/profile_drawer.js
   Shared account avatar + profile drawer
   Works on index.html and all /pages/*.html pages.
============================================================ */
...
function wireEvents() {
  ...
  const logoutButton =
    document.getElementById("drawer-logout");
  ...
  const icons = {
    ...
    heart: `
      <svg
        ...
        stroke-width="1.8"
      >
        <path d="M12 20s-7-4.4-9.3-8.7C1.2 8 2.6 5 5.8 5c1.8 0 3.2 1 4.2 2.4C11 6 12.4 5 14.2 5c3.2 0 4.6 3 3.1 6.3C19 15.6 12 20 12 20z"/>
      </svg>
    `,
